      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12 mb-4 mt-1">
            <h4 class="font-weight-bold">User Dashboard</h4>
          </div>
        </div>
                        ...
                        <div>
                          <ul class="list-style-1 mb-0">
                            <li class="list-item d-flex justify-content-start align-items-center">
                              <div class="avatar">
                                <img class="avatar avatar-img avatar-60 rounded-circle" src="{{url('upload_image')}}/{{$result[0]->profile_pic}}" alt="01.jpg" />
                              </div>
                              <div class="list-style-detail ml-4 mr-2">
                                <h5 class="font-weight-bold">{{$result[0]->name}}</h5>
                                <p class="mb-0 mt-1 text-muted">{{$result[0]->address}}</p>
                              </div>
                            </li>
                          </ul>
                        </div>
                      ...
                      <li class="list-group-item">
                        <table class="table table-borderless mb-0">
                          ...
                          <tr>
                            ...
                            <td>
                              <p class="mb-0 ">{{$result[0]->contact}}</p>
                            </td>
                          </tr>
                          <tr>
                            <td class="p-0">
                          ...
                          <tr>
                            ...
                            <td>
                              <p class="mb-0 ">{{$result[0]->address}}</p>
                            </td>
                          </tr>
                        </table>
                      </li>
                    ...
                    <div class="card-body p-0">
                      ...
                      <div class="tab-content">
                        <div id="invoice" class="tab-pane fade show active">
                          <div class="d-flex justify-content-between align-items-center p-3">
                            <h5>Invoice List</h5>
                            <button class="btn btn-secondary btn-sm" id="export">
