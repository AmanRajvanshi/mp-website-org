            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center">
              ...
              <div class="form-group mb-0 d-flex flex-row">
                <div class="date-icon-set">
                  <input type="date" name="start" class="form-control" placeholder="From Date" style="padding-right:40px;">
                ...
                <div class="date-icon-set">
                  <input type="date" name="end" class="form-control" placeholder="To Date" style="padding-right:40px;">
                  <span class="search-link">
                    <svg xmlns="http://www.w3.org/2000/svg" class="" width="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                ...
                <div class="card bg-primary">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="ml-3">
                        <h5 class="text-white font-weight-bold">1,860 <small> /3k Target</small>
                        </h5>
