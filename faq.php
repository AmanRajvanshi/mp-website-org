        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="hero-txt  white-color">
              <!-- Title -->
              <h1 class="h2-md">Ask Us, Always ready to help you</h1>
              <!-- Text -->
              <p class="p-xl" style="color:#5d5d5d">Got any questions? We are here to solve your query. Feel free to contact us
                </h5>
            </div>
          </div>
        </div>
